...
import 'package:responsive_ui/Screen/DeviceScreeen.dart';
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) {
        return MaterialApp(
          ...
          builder: DevicePreview.appBuilder, // Use the DevicePreview builder
          home: const Devicescreeen(), // Corrected class name
        );
      },
    );
  }
